...
class RegularStock extends \Magento\Config\Block\System\Config\Form\Field
{
    /**
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->getTemplate()) {
            $this->setTemplate('system/config/RegularStock.phtml');
        }
        return $this;
    }
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $this->addData(
            [
                ...
                'ajax_url' => $this->_urlBuilder->getUrl('dynamic_ftpimportexport/run/regularStock'),
            ]
        );
        return $this->_toHtml();
    }
